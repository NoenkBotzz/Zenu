...
// Base 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬 : Copyan Dari Base Dika

› Create By 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬
› Base Ori 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬
› Copyan Base Dika haikal Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬*/
...
// COMMAND GUA SULITIN
const kalimage = fs.readFileSync ('./RyanMods.jpg')
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": ppnyauser,"sourceUrl": `https://www.youtube.com/@ryanmods28`}}}, { quoted:m})} 
//=================================================//
...
ppuser = 'https://telegra.ph/file/4a1b8e34cd56417bc4a1a.jpg'
}
ppnyauser = await getBuffer(ppuser)
async function replyReg(teks) {
const templateButtonoos = [
{index: 1, urlButton: {displayText: 'Owner Nya Tod', url: `https://wa.me/6285717376113`}}
]
...
jpegThumbnail:log0,
caption:`
Hallo Kak ${pushname}👋Selamat ${salam}

°Owner : 6285717376113
°Versi : 13
°Creator : 彡𝐑𝐲𝐚𝐧 𝐌𝐨𝐝𝐝𝐞𝐫友
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
Aku adalah bot private RyanMods
Ingin bisa akses bot private?
Chats owner untuk mengetahui
password nya toddd!!
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
 `,
footer: '彡𝐑𝐲𝐚𝐧 𝐌𝐨𝐝𝐝𝐞𝐫',
...
const templateButtonoos = [
{index: 1, urlButton: {displayText: 'Creator', url: `https://www.youtube.com/@ryanmods28`}}
]
const templateMessaggge = {
video:fs.readFileSync("./baseikal/video/haikal.mp4"),
gifPlayback:true,
...
"message": `${teks}`,
"orderTitle": `${teks}`,
"sellerJid": "6285717376113@s.whatsapp.net",
...
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!q) return m.reply(`Penggunaan ${command} Textnya\n\nContoh : ${command} ryanmods`)
let teks = `${q}`
{
...
"options": [
{
"optionName": `${teks} Suka coli`
},
{
"optionName": `Kalau Ada ${teks} Jangan lari`
}
],
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `🔥 ${teks} ${buttonkal}`,
showAdAttribution: true,
sourceUrl: `https://www.youtube.com/@ryanmods28`,
thumbnailUrl: 'https://telegra.ph/file/4a1b8e34cd56417bc4a1a.jpg', 
}
}}}}}, { quoted:m})
}
}
...
haikal.sendMessage(m.chat, buttonnnnmMessage)
 ...
 break
//=================================================//
case 'buglist1': case 'buglist2': case 'buglist3': case 'buglist4': case 'buglist5':
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
...
touchmebre = [
{
title: `🌷𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(Pe, `🌷𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬🌷`, haikal.user.name, `Hay Kak Sc Bot Ryan Ada Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'troli1': case 'troli3': case 'troli4': case 'troli5': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
let dok = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${ownername}`,jpegThumbnail: thumb}}}
...
break
//=================================================//
case 'docu1': case 'docu3': case 'docu4': case 'docu5': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!text) throw `Cara penggunaan\nContoh : ${prefix + command} 628XXXXX`
Pe = text.split("|")[0]+'@s.whatsapp.net'
...
reply(`Berhasil Mengirim Bug ${prefix + command} Di Nomer ${text}@s.whatsapp.net`)
}
break
//=================================================//
case 'docu2': {
...
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone1}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone2}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone3}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone4}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone5}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone6}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${buttonkal}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${buttonvirus}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`}, { quoted:m })
}
}
break
case 'virus1': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone}` }, { quoted:m })
}
break
//=================================================//
case 'virus2': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone1}` }, { quoted:m })
}
break
//=================================================//
case 'virus3': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone2}` }, { quoted:m })
}
break
//=================================================//
case 'virus4': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone3}` }, { quoted:m })
}
break
//=================================================//
case 'virus5': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone4}` }, { quoted:m })
}
break
//=================================================//
case 'virus6': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone5}` }, { quoted:m })
}
break
//=================================================//
case 'virus7': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${iphone6}` }, { quoted:m })
}
break
//=================================================//
case 'virus8': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${buttonkal}` }, { quoted:m })
}
break
//=================================================//
case 'virus9': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${buttonvirus}` }, { quoted:m })
}
break
//=================================================//
case 'virus10': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`}, { quoted:m })
}
break
//=================================================//
case 'jadijago': {
...
break
//=================================================//
case 'lokas1': case 'lokas3': case 'lokas4': case 'lokas5': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!text) throw `Cara penggunaan\nContoh : ${prefix + command} 628XXXXX`
Pe = text.split("|")[0]+'@s.whatsapp.net'
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: m.chat, quoted:m})
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot RyanMods${text ? ': ' + text : ''}`)
}
break
//=================================================//
case '🥀': 
...
break
//=================================================//
case '🍒': case '🦕': case '😎': case '😡': case '⚡': case '💥': case '🍋': case '❤️':{
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case '🌷' : case '🗿': case '🔥': case '🍎': case '🎄': case '🍉': case '🌺': case '☕': case '💣': case '😘': case '🍁': case 'crash': case 'brutal': case 'ganas': case 'santet': case 'slebew': case '🐣': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!text) throw `Cara penggunaan\nContoh : ${prefix + command} 628XXXXX`
Pe = text.split("|")[0]+'@s.whatsapp.net'
...
reply(`Berhasil Send Bug ${prefix + command} Di Nomer ${text}@s.whatsapp.net`)
}
break
case 'santetgc' : {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!text) throw `Cara penggunaan\nContoh : ${prefix + command} Linkgroups`
...
break
//=================================================//
case 'invite1': case 'invite2': case 'invite3': case 'invite4': case 'invite5':{
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!text) throw `Cara penggunaan\nContoh : ${prefix + command} 628XXXXX`
Pe = text.split("|")[0]+'@s.whatsapp.net'
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"groupName": `MY NAME 𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
...
haikal.sendMessage(m.chat, anuala, `𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
if (!args[0]) return m.reply(`Penggunaan Contoh : user add 628xxx`)
if (args[1]) {
orgnye = args[1]
} else if (m.quoted) {
...
if (!isCwner) return m.reply('User bukan owner lagi')
...
Base script
© 彡𝐑𝐲𝐚𝐧 𝐌𝐨𝐝𝐝𝐞𝐫友`,
contextInfo:{"externalAdReply": {"title": `彡𝐑𝐲𝐚𝐧 𝐌𝐨𝐝𝐝𝐞𝐫`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/6285717376113`,
thumbnailUrl: 'https://telegra.ph/file/4a1b8e34cd56417bc4a1a.jpg', 
}
}}, { quoted:m})
}
...
❍ JADI BUG VIP ❍
┏━━⊱
┣❏➥ Jadivirtext1 (textnya)
┣❏➥ Jadivirtext2 (textnya)
┣❏➥ Jadivirtext3 (textnya)
┣❏➥ Jadivirtext4 (textnya)
┣❏➥ Jadivirtext5 (textnya)
┣❏➥ Jadivirtext6 (textnya)
┣❏➥ Jadivirtext7 (textnya)
┣❏➥ Jadivirtext8 (textnya)
┣❏➥ Jadivirtext9 (textnya)
┣❏➥ Jadivirtext10 (textnya)
┣❏➥ Jadijago (textnya)
┣❏➥ Jadipolling (textnya)
┣❏➥ Jaditroli (textnya)
┣❏➥ Jadilokas (textnya)
┣❏➥ Jadidarknes (textnya)
┣❏➥ Jadidocu (textnya)
┣❏➥ Jadibuginvite (textnya)
┣❏➥ Jadibugsw (textnya)
┣❏➥ Jadibugpayment (textnya)
┣❏➥ Jadibugbutton (textnya)
...
showAdAttribution: true,
sourceUrl: `https://www.youtube.com/@ryanmods28`,
thumbnailUrl: 'https://telegra.ph/file/d1bd7f433fb750f57d0ee.jpg', 
}
}}, { quoted:m})
}
break
...
maaf ga nyediain sewa kalau jadi murbug bisa chat owner wa.me/6285717376113`)
}
break
//=================================================//
...
break
//=================================================//
case 'assalamualaikum': case 'p': case 'bang': case 'woyy': case 'bng': case 'jo': case 'bg': case 'pp': case 'ppp': {
hiy = fs.readFileSync('./baseikal/sound/salam.mp3')
...
break
//=================================================//
case 'oke': case 'anjing': case 'anjay': case 'ajg': case 'tolol': case 'thanks' : case 'makasih': case 'mksh': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
